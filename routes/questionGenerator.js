...
function makeMultipleChoice(questionText, correctAnswer, steps, hint) {
  ...
  return { questionText, correctAnswer, options: choices, solutionSteps: steps, hint, isMultipleChoice: true };
}

function makeTypein(questionText, correctAnswer, steps, hint) {
  return { questionText, correctAnswer, options: null, solutionSteps: steps, hint, isMultipleChoice: false };
}
